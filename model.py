...
with tf.Session() as sess:
    ...
    for i in range(30):
        ...
        eval_result = classifier.evaluate(
            input_fn=lambda: train_input_fn2(32))
        # eval_result1 = classifier.evaluate(
        #     input_fn=lambda: eval_input_fn(32))
        print(eval_result)
        #print(eval_result1)
    ...
    # predict
    # '''
    # predict_result = list(classifier.predict(input_fn=lambda: predict_input_fn(1), predict_keys='classes'))
    # ans = []
    # for result in predict_result:
    #     ans.append(result['classes'])
    #     print(result)
    # for i in range(len(labelsPic_predict)):
    #     labelsPic_predict.iloc[i,1] = ans[i]
    # labelsPic_predict.to_csv('sub70_11.csv',index=None)
    # print('finish')
